...
## Setup
1. Clone this repository: `git clone https://github.com/tariq-shuvo/discord-application.git` then navigate to the folder 
   folder named `discord-application`
2. Install dependencies with `npm i`
3. Rename file `config.example.json` to `config.json`, replacing the placeholder values with your desired command prefix and your bot token (If you 
...
If you don't want to keep your computer on 24/7 to host the bot, I recommend a heroku server.
